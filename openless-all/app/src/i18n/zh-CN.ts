...
export const zhCN = {
  cloudSyncE2ee: {
    ...
    keyLocked: '此设备尚未解锁',
    keyUnlocked: '此设备已解锁',
    hasSnapshot: '云端已有加密备份。',
    noSnapshot: '云端尚无加密备份。',
    snapshotUnknown: '尚未检查云端备份。',
    lastSync: '上次同步：{{time}}',
    syncNow: '立即同步',
    checkPending: '核对待确认结果',
    unlock: '解锁',
    lock: '锁定此设备',
    changePassword: '更改同步密码',
    restore: '审阅云端恢复',
    delete: '删除云端备份',
    working: '正在处理…',
    cancelTask: '取消当前任务',
    cancelRequested: '已请求取消，正在等待当前任务结束。',
    done: '同步设置已更新。',
    restored: '已恢复云端资料，请核对本设备的专属设置。',
    retryAfter: '请在 {{seconds}} 秒后重试。',
    passwordWarning: '请妥善保管同步密码。密码无法找回，遗失后可能无法读取云端资料。',
    consentTitle: '启用端到端加密同步',
    consentDescription:
      '同步内容包含服务凭据和私密文本历史，资料会在本机加密后上传。请先了解完整范围。',
    scopeSummary: '查看完整同步范围',
    consentCheck: '我已了解完整范围，并同意加密同步这些资料。',
    continue: '继续',
    createTitle: '设置同步密码',
    unlockTitle: '解锁云端备份',
    passwordTitle: '更改同步密码',
    create: '创建加密备份',
    password: '同步密码',
    newPassword: '新同步密码',
    currentPassword: '当前同步密码',
    confirmPassword: '再次输入新密码',
    passwordPolicy: '使用 12–128 个字符，包含大写字母、小写字母和数字，避免常见弱密码。',
    rememberKey: '在此设备的安全存储中记住解锁密钥',
    disableTitle: '关闭加密同步？',
    disableDescription:
      '关闭后停止后续同步，云端备份和本机资料都会保留。删除云端备份是另一项独立操作。',
    confirmDisable: '关闭同步',
    deleteTitle: '删除云端加密备份？',
    deleteDescription:
      '仅删除当前账号的云端备份，本机资料保留。以后在其他设备恢复前，需要重新创建备份。',
    backupRetention: '删除后，服务备份副本最多保留 {{days}} 天。',
    deleteCheck: '我确认删除这份云端备份。',
    confirmDelete: '删除云端备份',
    restoreTitle: '恢复前审阅',
    restoreDescription: '请检查下列资料类别，敏感值不会展示。确认之前不会恢复任何内容。',
    deviceReview: '恢复后请核对 {{count}} 项设备配置，包括快捷键、模型目录、麦克风及系统授权。',
    restoreMode: '恢复方式',
    merge: '合并，并逐项处理冲突',
    replace: '使用云端资料替换本机同步资料',
    replaceWarning: '此操作会替换同步范围内的本机资料。若要保留本机修改，请选择合并。',
    restoreCheck: '我已检查恢复方式和冲突处理选择。',
    applyRestore: '确认恢复',
    conflictProgress: '已处理 {{selected}} / {{total}} 项冲突',
    conflictItem: '冲突 {{index}} · {{category}}',
    conflictLocal: '保留本机',
    conflictCloud: '使用云端',
    previous: '上一页',
    next: '下一页',
    scope: {
      preferences: '应用偏好与界面设置。',
      credentials: 'ASR、LLM、Omni 渠道及服务 API keys、ID、access key、secret key 等凭据。',
      personal: '词典、自定义词汇预设、纠错、风格包及图标。',
      history: '全部听写与速记文本历史，以及活动统计。',
      device: '设备配置档案，恢复后需在目标设备核对。',
      excluded:
        '不包含 OAuth 登录态、同步密码或派生密钥、操作系统凭据文件、PIN、设备权限、原始录音与视频，以及模型权重。',
    },
    states: {
      disabled: '同步已关闭',
      sign_in_required: '需要登录 GitHub',
      unlock_required: '请输入密码解锁',
      ready: '已同步',
      pending: '本机更改待同步',
      syncing: '正在同步',
      conflict: '请审阅冲突更改',
      failed: '同步需要处理',
      outcome_unknown: '云端结果待确认',
      recovery_required: '需要恢复本机同步状态',
    },
    categories: {
      preferences: '应用偏好',
      ui_preferences: '界面设置',
      channels: '服务渠道与凭据',
      provider_credentials: '服务凭据',
      dictionary: '词典',
      vocabulary_presets: '自定义词汇预设',
      corrections: '纠错规则',
      style_packs: '风格包与图标',
      history: '文本历史',
      activity: '活动统计',
      device_profile: '设备配置档案',
      other: '其他同步资料',
    },
    conflictReasons: {
      both_modified: '本机和云端都修改了这项资料。',
      delete_modify: '一端删除了这项资料，另一端进行了修改。',
      no_common_baseline: '没有共同的同步基线，请选择要保留的一端。',
      other: '请选择本机或云端版本，具体值不会展示。',
    },
    errors: {
      unknown: '操作未能完成，请刷新状态后重试。',
      signIn: '请重新登录 GitHub。',
      unlock: '请先使用同步密码解锁此设备。',
      unavailable: '加密同步暂不可用，请使用原生客户端并稍后检查服务。',
      weakPassword: '请使用满足长度和字符要求、且不常见的强密码。',
      passwordMismatch: '两次输入的密码不一致。',
      invalidPassword: '密码无法解锁这份备份，或加密资料校验未通过。',
      secureStorage: '安全存储拒绝访问。请检查设备授权，或取消记住密钥后解锁。',
      changed: '审阅期间资料已改变。请关闭弹窗、刷新状态，并重新获取预览。',
      accountChanged: 'GitHub 账号已改变，请刷新后再继续。',
      busy: '已有同步任务在运行，请等待或先取消。',
      cancelled: '任务已取消。',
      network: '暂时无法连接同步服务，请检查网络后重试。',
      rateLimited: '请求过于频繁，请稍后重试。',
      outcomeUnknown: '云端结果尚未确认。请先核对待确认结果，不要重复创建备份。',
      recovery: '本机同步状态需要恢复。请保留本机资料，不要覆盖云端备份。',
      rolledBack: '恢复失败，本机更改已回滚。请刷新状态后重试。',
      tooLarge: '加密备份超出服务的大小限制。',
      reviewRequired: '请先确认完整同步范围，并审阅云端恢复预览。',
      choicesRequired: '请为每项冲突选择本机或云端版本。',
      invalidData: '加密备份未通过校验，本机资料未被替换。',
      localData: '无法安全准备本机资料，请刷新后重试。',
    },
  },
  cloudSync: {
    title: '云同步',
  ...
  qa: {
    compact: {
      closeError: '关闭失败，请重试。',
      sendError: '发送失败，输入已保留，请重试。',
      microphoneError: '麦克风操作失败，请重试。',
      modeError: '编辑模式未更改，请重试。',
      conversation: '当前会话',
      sending: '正在发送提问…',
      addUnavailable: '添加内容 · 暂不可用',
      browserUnavailable: '预览不执行指令',
      answer: 'OpenLess 回答',
      layoutError: '窗口展开失败，请关闭后重新打开。',
    },
    title: '划词追问',
    headerHint: '随时提问',
    thinking: '思考中…',
  ...
  lessComputer: {
    desktop: {
      ...
      agents: '你的 Agents',
      configured: '当前配置',
      agentSettings: '在设置中选择',
      historyUnavailable: '历史记录 · 暂不可用',
      sessionUnavailable: '新会话 · 暂不可用',
      agentHint: '在设置中选择使用的 Agent。',
      workspace: '工作区',
      multitask: '多任务',
      unavailable: '暂不可用',
      historyHint: '四个 Agent 的历史与多会话功能尚未开放。',
      signedIn: '已登录',
      signIn: '登录账号',
      currentSession: '当前会话',
      minimize: '最小化',
      maximize: '最大化 / 还原',
      windowError: '窗口操作未完成，请重试。',
      emptyHint: '写下具体任务，或用已配置的说话快捷键，让想法开始行动。',
      voiceHint: '按住说话快捷键',
      idle: '等待指令',
      waitingApproval: '等待你的确认',
      submittingApproval: '正在提交…',
      approvalError: '审批未提交成功，请重试。',
      approvalExpired: '此轮已结束，审批已不可用。',
      sendError: '发送失败，输入已保留。请重试。',
      browserUnavailable: '浏览器预览不会执行指令，请在桌面应用中使用。',
      cancelHint: '可从胶囊取消正在运行的任务。',
      inputHint: 'Enter 发送 · Shift + Enter 换行',
      activity: '任务动态',
      noActivity: '尚无任务活动',
      activityHint: '任务开始后，工具调用与审批会显示在这里。',
      currentTask: '当前任务',
      toolActive: '调用中',
      toolReported: '已收到调用记录',
      approval: '操作审批',
      apiCost: '本轮 API 费用',
      activitySource: '随当前任务更新。费用仅在服务返回时显示。',
    },
    title: 'Less Computer',
    subtitle: '想让电脑做什么？',
    you: '你',
  ...
  settings: {
    ...
    providers: {
      ...
      bailianProtocolLabel: '接口类型',
      bailianProtocolNote:
        '手动选择优先于模型名称，按渠道保存，同时用于验证和录音。请根据模型文档选择接口。',
      bailianProtocolOptions: {
        auto: '自动识别',
        'dashscope-realtime': '实时（DashScope）',
        'qwen-realtime': '实时（Qwen Realtime）',
        multimodal: '非实时同步（Fun-ASR / Qwen-Audio）',
        'qwen-multimodal': '非实时同步（Qwen3-ASR）',
        'async-transcription': '非实时异步（文件转写）',
      },
  ...
  localAsr: {
    ...
    groupOther: '其他',
    mirrorLabel: '下载镜像源',
    mirrorDesc: '可切换 HuggingFace、国内社区镜像或受支持模型的 ModelScope 官方仓库。',
