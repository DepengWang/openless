...
export const ko: typeof zhCN = {
  ...
  cloudSyncE2ee: {
    ...
    setupPromptLater: '나중에',
    setupPromptOpen: '암호화 동기화 알아보기',
    title: '암호화 클라우드 동기화',
    description: '이 기기에서 암호화한 후 GitHub 계정으로 기기 간에 동기화합니다.',
    enable: '암호화 동기화 사용',
    refresh: '상태 새로고침',
    loading: '동기화 상태 확인 중…',
    signIn: 'GitHub로 로그인',
    ...
    account: '동기화 계정',
    keyLocked: '이 기기에서 잠김',
    keyUnlocked: '이 기기에서 잠금 해제됨',
    hasSnapshot: '암호화된 클라우드 백업이 있습니다.',
    noSnapshot: '아직 암호화된 클라우드 백업이 없습니다.',
    snapshotUnknown: '클라우드 백업을 아직 확인하지 않았습니다.',
    lastSync: '마지막 동기화: {{time}}',
    syncNow: '지금 동기화',
    checkPending: '확인 대기 결과 조회',
    unlock: '잠금 해제',
    lock: '이 기기 잠그기',
    changePassword: '동기화 비밀번호 변경',
    restore: '클라우드 복원 검토',
    delete: '클라우드 백업 삭제',
    working: '처리 중…',
    cancelTask: '현재 작업 취소',
    cancelRequested: '취소를 요청했습니다. 작업이 종료되기를 기다립니다.',
    done: '동기화 설정을 업데이트했습니다.',
    restored: '클라우드 데이터를 복원했습니다. 이 기기의 전용 설정을 확인하세요.',
    retryAfter: '{{seconds}}초 후 다시 시도하세요.',
    passwordWarning:
      '동기화 비밀번호를 안전하게 보관하세요. 복구할 수 없으며, 분실하면 클라우드 데이터를 읽지 못할 수 있습니다.',
    consentTitle: '종단 간 암호화 동기화 사용',
    consentDescription:
      '서비스 자격 증명과 비공개 텍스트 기록도 동기화됩니다. 업로드 전에 기기에서 암호화합니다. 전체 범위를 확인하세요.',
    scopeSummary: '전체 동기화 범위 보기',
    consentCheck: '전체 범위를 이해했으며 이 데이터를 암호화해 동기화하는 데 동의합니다.',
    continue: '계속',
    createTitle: '동기화 비밀번호 설정',
    unlockTitle: '클라우드 백업 잠금 해제',
    passwordTitle: '동기화 비밀번호 변경',
    create: '암호화 백업 만들기',
    password: '동기화 비밀번호',
    newPassword: '새 동기화 비밀번호',
    currentPassword: '현재 동기화 비밀번호',
    confirmPassword: '새 비밀번호 확인',
    passwordPolicy: '12~128자로 영문 대문자, 소문자, 숫자를 포함하세요. 흔한 비밀번호는 피하세요.',
    rememberKey: '이 기기의 보안 저장소에 잠금 해제 키 기억',
    disableTitle: '암호화 동기화를 끌까요?',
    disableDescription:
      '이후 동기화를 중지합니다. 클라우드 백업과 로컬 데이터는 유지됩니다. 백업 삭제는 별도 작업입니다.',
    confirmDisable: '동기화 끄기',
    deleteTitle: '암호화된 클라우드 백업을 삭제할까요?',
    deleteDescription:
      '이 계정의 클라우드 백업만 삭제합니다. 로컬 데이터는 유지됩니다. 다른 기기에서 복원하려면 새 백업이 필요합니다.',
    backupRetention: '삭제 후에도 서비스의 백업 사본이 최대 {{days}}일 동안 보관될 수 있습니다.',
    deleteCheck: '이 클라우드 백업 삭제에 동의합니다.',
    confirmDelete: '클라우드 백업 삭제',
    restoreTitle: '복원 전 검토',
    restoreDescription:
      '데이터 종류를 확인하세요. 민감한 값은 표시하지 않습니다. 확인 전에는 복원하지 않습니다.',
    deviceReview:
      '복원 후 단축키, 모델 경로, 마이크, 시스템 권한 등 기기 설정 {{count}}개를 확인하세요.',
    restoreMode: '복원 방식',
    merge: '병합하고 충돌 해결',
    replace: '동기화 대상 로컬 데이터를 클라우드 데이터로 교체',
    replaceWarning:
      '동기화 범위의 로컬 데이터를 교체합니다. 로컬 변경을 유지하려면 병합을 선택하세요.',
    restoreCheck: '복원 방식과 충돌 선택을 확인했습니다.',
    applyRestore: '복원 확인',
    conflictProgress: '충돌 {{total}}개 중 {{selected}}개 해결',
    conflictItem: '충돌 {{index}} · {{category}}',
    conflictLocal: '로컬 유지',
    conflictCloud: '클라우드 사용',
    previous: '이전',
    next: '다음',
    scope: {
      preferences: '앱 환경설정과 인터페이스 설정.',
      credentials: 'ASR·LLM·Omni 채널과 API 키, ID, 액세스 키, 시크릿 키 등의 자격 증명.',
      personal: '사전, 사용자 어휘 프리셋, 교정, 스타일 팩과 아이콘.',
      history: '전체 받아쓰기·빠른 메모 텍스트 기록과 활동 통계.',
      device: '복원 대상 기기에서 확인할 기기 설정 프로필.',
      excluded:
        'OAuth 로그인 상태, 동기화 비밀번호·파생 키, OS 자격 증명 파일, PIN, 기기 권한, 원본 녹음·동영상, 모델 가중치는 포함하지 않습니다.',
    },
    states: {
      disabled: '동기화 꺼짐',
      sign_in_required: 'GitHub 로그인 필요',
      unlock_required: '비밀번호를 입력해 잠금을 해제하세요',
      ready: '최신 상태',
      pending: '로컬 변경 동기화 대기 중',
      syncing: '동기화 중',
      conflict: '충돌하는 변경 검토 필요',
      failed: '동기화 확인 필요',
      outcome_unknown: '클라우드 결과 확인 대기 중',
      recovery_required: '로컬 상태 복구 필요',
    },
    categories: {
      preferences: '앱 환경설정',
      ui_preferences: '인터페이스 설정',
      channels: '서비스 채널 및 자격 증명',
      provider_credentials: '서비스 자격 증명',
      dictionary: '사전',
      vocabulary_presets: '사용자 어휘 프리셋',
      corrections: '교정 규칙',
      style_packs: '스타일 팩과 아이콘',
      history: '텍스트 기록',
      activity: '활동 통계',
      device_profile: '기기 설정 프로필',
      other: '기타 동기화 데이터',
    },
    conflictReasons: {
      both_modified: '로컬과 클라우드 양쪽에서 변경되었습니다.',
      delete_modify: '한쪽에서 삭제하고 다른 쪽에서 변경했습니다.',
      no_common_baseline: '공통 동기화 기준이 없습니다. 유지할 버전을 선택하세요.',
      other: '로컬 또는 클라우드를 선택하세요. 실제 값은 표시하지 않습니다.',
    },
    errors: {
      unknown: '작업을 완료하지 못했습니다. 상태를 새로고침한 후 다시 시도하세요.',
      signIn: 'GitHub에 다시 로그인하세요.',
      unlock: '먼저 동기화 비밀번호로 이 기기를 잠금 해제하세요.',
      unavailable:
        '암호화 동기화를 사용할 수 없습니다. 네이티브 앱에서 나중에 서비스를 확인하세요.',
      weakPassword: '길이와 문자 조건을 충족하는 더 강력한 비밀번호를 사용하세요.',
      passwordMismatch: '두 비밀번호가 일치하지 않습니다.',
      invalidPassword:
        '비밀번호로 백업을 잠금 해제할 수 없거나 암호화 데이터를 검증하지 못했습니다.',
      secureStorage:
        '보안 저장소 접근이 거부되었습니다. 권한을 확인하거나 키를 기억하지 않고 잠금 해제하세요.',
      changed:
        '검토 중 데이터가 변경되었습니다. 창을 닫고 새로고침한 후 미리보기를 다시 확인하세요.',
      accountChanged: 'GitHub 계정이 변경되었습니다. 새로고침한 후 계속하세요.',
      busy: '다른 동기화 작업이 실행 중입니다. 기다리거나 먼저 취소하세요.',
      cancelled: '작업이 취소되었습니다.',
      network: '동기화 서비스에 연결할 수 없습니다. 네트워크를 확인한 후 다시 시도하세요.',
      rateLimited: '요청이 너무 많습니다. 잠시 후 다시 시도하세요.',
      outcomeUnknown:
        '클라우드 결과가 확인되지 않았습니다. 새 백업을 만들기 전에 대기 중인 결과를 확인하세요.',
      recovery:
        '로컬 상태 복구가 필요합니다. 이 기기의 데이터를 보관하고 클라우드 백업을 덮어쓰지 마세요.',
      rolledBack: '복원에 실패해 로컬 변경을 되돌렸습니다. 새로고침한 후 다시 시도하세요.',
      tooLarge: '암호화 백업이 서비스 크기 제한을 초과합니다.',
      reviewRequired: '계속하기 전에 동기화 범위와 복원 미리보기를 확인하세요.',
      choicesRequired: '각 충돌에 대해 로컬 또는 클라우드를 선택하세요.',
      invalidData: '암호화 백업을 검증하지 못했습니다. 로컬 데이터는 교체되지 않았습니다.',
      localData: '로컬 데이터를 안전하게 준비하지 못했습니다. 새로고침한 후 다시 시도하세요.',
    },
  },
  cloudSync: {
    title: '클라우드 동기화',
  ...
  qa: {
    compact: {
      closeError: '닫지 못했습니다. 다시 시도하세요.',
      sendError: '전송하지 못했습니다. 입력 내용은 유지됩니다. 다시 시도하세요.',
      microphoneError: '마이크 작업에 실패했습니다. 다시 시도하세요.',
      modeError: '편집 모드를 변경하지 못했습니다. 다시 시도하세요.',
      conversation: '현재 대화',
      sending: '질문 전송 중…',
      addUnavailable: '콘텐츠 추가 · 아직 지원 안 함',
      browserUnavailable: '미리보기에서는 실행할 수 없음',
      answer: 'OpenLess 답변',
      layoutError: '창을 확장하지 못했습니다. 닫고 다시 열어 주세요.',
    },
    title: '질문',
  ...
  lessComputer: {
    desktop: {
      ...
      agents: '내 에이전트',
      configured: '현재 설정',
      agentSettings: '설정에서 선택',
      historyUnavailable: '기록 · 아직 지원 안 함',
      sessionUnavailable: '새 대화 · 아직 지원 안 함',
      agentHint: '사용할 에이전트는 설정에서 선택하세요.',
      workspace: '작업 공간',
      multitask: '여러 작업',
      unavailable: '아직 사용할 수 없음',
      historyHint: '네 에이전트의 기록과 여러 대화 기능은 아직 지원하지 않습니다.',
      signedIn: '로그인됨',
      signIn: '로그인',
      currentSession: '현재 대화',
      minimize: '최소화',
      maximize: '최대화 / 복원',
      windowError: '창 작업에 실패했습니다. 다시 시도하세요.',
      emptyHint: '구체적인 작업을 입력하거나 설정한 음성 단축키로 시작하세요.',
      voiceHint: '음성 단축키를 길게 누르세요',
      idle: '지시 대기 중',
      waitingApproval: '승인 대기 중',
      submittingApproval: '제출 중…',
      approvalError: '승인이 제출되지 않았습니다. 다시 시도하세요.',
      approvalExpired: '이 차례는 종료되어 더 이상 승인할 수 없습니다.',
      sendError: '전송하지 못했습니다. 입력 내용은 유지됩니다. 다시 시도하세요.',
      browserUnavailable:
        '브라우저 미리보기에서는 명령을 실행할 수 없습니다. 데스크톱 앱을 사용하세요.',
      cancelHint: '실행 중인 작업은 캡슐에서 취소할 수 있습니다.',
      inputHint: 'Enter로 전송 · Shift + Enter로 줄 바꿈',
      activity: '작업 활동',
      noActivity: '아직 활동이 없습니다',
      activityHint: '작업이 시작되면 도구 호출과 승인이 여기에 표시됩니다.',
      currentTask: '현재 작업',
      toolActive: '호출 중',
      toolReported: '호출 기록 수신',
      approval: '작업 승인',
      apiCost: '이번 API 비용',
      activitySource: '현재 작업과 함께 업데이트됩니다. 비용은 서비스가 보고할 때만 표시됩니다.',
    },
    title: 'Less Computer',
  ...
  settings: {
    ...
    providers: {
      ...
      bailianProtocolNote:
        '수동 선택은 모델 이름 감지보다 우선하며 검증과 녹음에 사용할 채널별 설정으로 저장됩니다. 모델 문서에 따라 선택하세요.',
  ...
  localAsr: {
    ...
    groupOther: '기타',
    mirrorLabel: '다운로드 미러',
    mirrorDesc: 'HuggingFace, 커뮤니티 미러 또는 지원 모델의 공식 ModelScope 저장소를 선택합니다.',
