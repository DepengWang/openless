...
export const ja: typeof zhCN = {
  ...
  cloudSyncE2ee: {
    ...
    setupPromptLater: '今はしない',
    setupPromptOpen: '暗号化同期について',
    title: '暗号化クラウド同期',
    description: 'この端末で暗号化してから、GitHub アカウントで端末間を同期します。',
    enable: '暗号化同期を有効にする',
    refresh: '状態を更新',
    loading: '同期状態を確認中…',
    signIn: 'GitHub でログイン',
    signOut: 'ログアウト',
    account: '同期アカウント',
    keyLocked: 'この端末ではロック中',
    keyUnlocked: 'この端末でロック解除済み',
    hasSnapshot: '暗号化されたクラウドバックアップがあります。',
    noSnapshot: '暗号化クラウドバックアップはまだありません。',
    snapshotUnknown: 'クラウドバックアップは未確認です。',
    lastSync: '最終同期：{{time}}',
    syncNow: '今すぐ同期',
    checkPending: '未確定の結果を確認',
    unlock: 'ロック解除',
    lock: 'この端末をロック',
    changePassword: '同期パスワードを変更',
    restore: 'クラウドからの復元を確認',
    delete: 'クラウドバックアップを削除',
    working: '処理中…',
    cancelTask: '現在の処理をキャンセル',
    cancelRequested: 'キャンセルを要求しました。処理の終了を待っています。',
    done: '同期設定を更新しました。',
    restored: 'クラウドのデータを復元しました。この端末固有の設定を確認してください。',
    retryAfter: '{{seconds}} 秒後に再試行してください。',
    passwordWarning:
      '同期パスワードは安全に保管してください。再発行できず、紛失するとクラウドのデータを読めなくなる場合があります。',
    consentTitle: 'エンドツーエンド暗号化同期を有効にする',
    consentDescription:
      'サービスの認証情報と非公開のテキスト履歴も同期します。アップロード前に端末で暗号化します。対象範囲を確認してください。',
    scopeSummary: '同期する全データを確認',
    consentCheck: '対象範囲を理解し、これらのデータの暗号化同期に同意します。',
    continue: '続ける',
    createTitle: '同期パスワードを設定',
    unlockTitle: 'クラウドバックアップを解除',
    passwordTitle: '同期パスワードを変更',
    create: '暗号化バックアップを作成',
    password: '同期パスワード',
    newPassword: '新しい同期パスワード',
    currentPassword: '現在の同期パスワード',
    confirmPassword: '新しいパスワードを再入力',
    passwordPolicy:
      '12～128 文字で英大文字・英小文字・数字を含めてください。よくあるパスワードは避けてください。',
    rememberKey: 'この端末の安全なストレージに解除キーを記憶する',
    disableTitle: '暗号化同期をオフにしますか？',
    disableDescription:
      '以後の同期を停止します。クラウドのバックアップとローカルのデータは残ります。削除は別の操作です。',
    confirmDisable: '同期をオフにする',
    deleteTitle: '暗号化クラウドバックアップを削除しますか？',
    deleteDescription:
      'このアカウントのクラウドバックアップのみ削除します。ローカルデータは残ります。別の端末で復元するには新しいバックアップが必要です。',
    backupRetention:
      '削除後も、サービスのバックアップコピーは最長 {{days}} 日間保持される場合があります。',
    deleteCheck: 'このクラウドバックアップの削除を確認します。',
    confirmDelete: 'クラウドバックアップを削除',
    restoreTitle: '復元前に確認',
    restoreDescription:
      'データの種類を確認してください。機密の値は表示しません。確認するまで復元しません。',
    deviceReview:
      '復元後は、ショートカット、モデルの場所、マイク、システム権限など {{count}} 件の端末設定を確認してください。',
    restoreMode: '復元方法',
    merge: 'マージして競合を解決',
    replace: '同期対象のローカルデータをクラウドの内容で置換',
    replaceWarning:
      '同期範囲のローカルデータを置き換えます。ローカルの変更を残すにはマージを選んでください。',
    restoreCheck: '復元方法と競合の選択を確認しました。',
    applyRestore: '復元を確認',
    conflictProgress: '{{total}} 件中 {{selected}} 件を選択済み',
    conflictItem: '競合 {{index}} · {{category}}',
    conflictLocal: 'ローカルを使用',
    conflictCloud: 'クラウドを使用',
    previous: '前へ',
    next: '次へ',
    scope: {
      preferences: 'アプリの環境設定と表示設定。',
      credentials:
        'ASR・LLM・Omni の接続設定と、API キー、ID、アクセスキー、シークレットキーなどの認証情報。',
      personal: '辞書、カスタム語彙プリセット、修正ルール、スタイルパックとアイコン。',
      history: 'すべての音声入力・クイックメモのテキスト履歴と利用統計。',
      device: '復元先の端末で確認するデバイス設定プロファイル。',
      excluded:
        'OAuth ログイン状態、同期パスワード・派生キー、OS の認証情報ファイル、PIN、端末の権限、元の録音・動画、モデルの重みは含みません。',
    },
    states: {
      disabled: '同期はオフです',
      sign_in_required: 'GitHub ログインが必要です',
      unlock_required: 'パスワードを入力して解除してください',
      ready: '同期済み',
      pending: 'ローカルの変更は同期待ちです',
      syncing: '同期中',
      conflict: '競合する変更を確認してください',
      failed: '同期の確認が必要です',
      outcome_unknown: 'クラウドの結果は未確定です',
      recovery_required: 'ローカル状態の復旧が必要です',
    },
    categories: {
      preferences: 'アプリ設定',
      ui_preferences: '表示設定',
      channels: 'サービス接続と認証情報',
      provider_credentials: 'サービス認証情報',
      dictionary: '辞書',
      vocabulary_presets: 'カスタム語彙プリセット',
      corrections: '修正ルール',
      style_packs: 'スタイルとアイコン',
      history: 'テキスト履歴',
      activity: '利用統計',
      device_profile: '端末設定プロファイル',
      other: 'その他の同期データ',
    },
    conflictReasons: {
      both_modified: 'ローカルとクラウドの両方で変更されています。',
      delete_modify: '一方で削除され、もう一方で変更されています。',
      no_common_baseline: '共通の同期履歴がありません。残す側を選んでください。',
      other: 'ローカルかクラウドを選択してください。値は表示しません。',
    },
    errors: {
      unknown: '操作を完了できませんでした。状態を更新して再試行してください。',
      signIn: 'GitHub に再ログインしてください。',
      unlock: '同期パスワードでこの端末を解除してください。',
      unavailable:
        '暗号化同期は利用できません。ネイティブアプリで後ほどサービスを確認してください。',
      weakPassword: '長さと文字種の条件を満たす、推測されにくいパスワードにしてください。',
      passwordMismatch: 'パスワードが一致しません。',
      invalidPassword: 'このパスワードで解除できないか、暗号化データを検証できませんでした。',
      secureStorage:
        '安全なストレージへのアクセスが拒否されました。権限を確認するか、キーを記憶せずに解除してください。',
      changed:
        '確認中にデータが変わりました。閉じて状態を更新し、再度プレビューを取得してください。',
      accountChanged: 'GitHub アカウントが変わりました。更新してから続けてください。',
      busy: '別の同期処理が実行中です。待つか先にキャンセルしてください。',
      cancelled: '処理をキャンセルしました。',
      network: '同期サービスに接続できません。ネットワークを確認して再試行してください。',
      rateLimited: 'リクエストが多すぎます。しばらく待ってから再試行してください。',
      outcomeUnknown:
        'クラウドの結果が未確定です。新しいバックアップを作る前に未確定の結果を確認してください。',
      recovery:
        'ローカル状態の復旧が必要です。この端末のデータを保持し、クラウドを上書きしないでください。',
      rolledBack: '復元に失敗し、ローカルの変更を元に戻しました。更新してから再試行してください。',
      tooLarge: '暗号化バックアップがサービスのサイズ上限を超えています。',
      reviewRequired: '続ける前に同期対象と復元プレビューを確認してください。',
      choicesRequired: 'すべての競合でローカルかクラウドを選択してください。',
      invalidData: '暗号化バックアップを検証できませんでした。ローカルデータは置き換えていません。',
      localData: 'ローカルデータを安全に準備できませんでした。更新して再試行してください。',
    },
  },
  cloudSync: {
    title: 'クラウド同期',
  ...
  qa: {
    compact: {
      closeError: '閉じられませんでした。再試行してください。',
      sendError: '送信できませんでした。入力は保持されています。再試行してください。',
      microphoneError: 'マイク操作に失敗しました。再試行してください。',
      modeError: '編集モードを変更できませんでした。再試行してください。',
      conversation: '現在の会話',
      sending: '質問を送信中…',
      addUnavailable: 'コンテンツを追加 · 未対応',
      browserUnavailable: 'プレビューでは実行できません',
      answer: 'OpenLess の回答',
      layoutError: 'ウィンドウを展開できませんでした。閉じてから開き直してください。',
    },
    title: '質問',
    headerHint: 'いつでも質問',
    thinking: '思考中…',
  ...
  lessComputer: {
    desktop: {
      ...
      configured: '現在の設定',
      agentSettings: '設定で選択',
      historyUnavailable: '履歴 · 未対応',
      sessionUnavailable: '新しい会話 · 未対応',
      agentHint: '使用するエージェントは設定で選択します。',
      workspace: 'ワークスペース',
      multitask: '複数のタスク',
      unavailable: 'まだ利用できません',
      historyHint: '4つのエージェントの履歴と複数会話には、まだ対応していません。',
      signedIn: 'ログイン済み',
      signIn: 'ログイン',
      currentSession: '現在の会話',
      minimize: '最小化',
      maximize: '最大化 / 元に戻す',
      windowError: 'ウィンドウ操作に失敗しました。再試行してください。',
      emptyHint: '具体的なタスクを入力するか、設定した音声ショートカットで始めましょう。',
      voiceHint: '音声ショートカットを長押し',
      idle: '指示を待っています',
      waitingApproval: '承認待ち',
      submittingApproval: '送信中…',
      approvalError: '承認を送信できませんでした。再試行してください。',
      approvalExpired: 'このターンは終了しました。承認はできません。',
      sendError: '送信できませんでした。入力は保持されています。再試行してください。',
      browserUnavailable:
        'ブラウザのプレビューでは実行できません。デスクトップアプリをご利用ください。',
      cancelHint: '実行中のタスクはカプセルからキャンセルできます。',
      inputHint: 'Enter で送信 · Shift + Enter で改行',
      activity: 'タスクの動き',
      noActivity: 'まだ動きはありません',
      activityHint: 'タスクが始まると、ツール呼び出しと承認がここに表示されます。',
      currentTask: '現在のタスク',
      toolActive: '呼び出し中',
      toolReported: '呼び出しを受信',
      approval: '操作の承認',
      apiCost: '今回の API 料金',
      activitySource:
        '現在のタスクに合わせて更新。料金はサービスから報告された場合のみ表示します。',
    },
    title: 'Less Computer',
  ...
  settings: {
    ...
    providers: {
      ...
      bailianProtocolNote:
        '手動選択はモデル名による判定より優先され、検証と録音用にチャネルごとに保存されます。モデルのドキュメントに従って選択してください。',
