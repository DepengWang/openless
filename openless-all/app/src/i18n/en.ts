...
export const en: typeof zhCN = {
  cloudSyncE2ee: {
    ...
    setupPromptLater: 'Not now',
    setupPromptOpen: 'Explore encrypted sync',
    title: 'Encrypted cloud sync',
    description: 'Encrypt on this device before syncing with your GitHub account.',
    ...
    keyLocked: 'Locked on this device',
    keyUnlocked: 'Unlocked on this device',
    hasSnapshot: 'An encrypted cloud backup is available.',
    noSnapshot: 'No encrypted cloud backup yet.',
    snapshotUnknown: 'Cloud backup has not been checked yet.',
    lastSync: 'Last synced {{time}}',
    syncNow: 'Sync now',
    checkPending: 'Check pending result',
    unlock: 'Unlock',
    lock: 'Lock this device',
    changePassword: 'Change sync password',
    restore: 'Review cloud restore',
    delete: 'Delete cloud backup',
    working: 'Working securely…',
    cancelTask: 'Cancel current task',
    cancelRequested: 'Cancellation requested. Waiting for the task to settle.',
    done: 'Sync settings updated.',
    restored: 'Cloud data restored. Review settings specific to this device.',
    retryAfter: 'Try again in {{seconds}} seconds.',
    passwordWarning:
      'Keep your sync password safe. It cannot be recovered; losing it can make cloud data unreadable.',
    consentTitle: 'Enable end-to-end encrypted sync',
    consentDescription:
      'This sync includes service credentials and private text history. Data is encrypted on your device before upload. Review the full scope first.',
    scopeSummary: 'View everything included',
    consentCheck: 'I understand the full scope and agree to sync this data in encrypted form.',
    continue: 'Continue',
    createTitle: 'Create a sync password',
    unlockTitle: 'Unlock your cloud backup',
    passwordTitle: 'Change your sync password',
    ...
    passwordPolicy:
      'Use 12–128 characters with uppercase and lowercase letters and a number. Avoid common passwords.',
    rememberKey: 'Remember the unlock key in this device’s secure storage',
    disableTitle: 'Turn off encrypted sync?',
    disableDescription:
      'This stops further sync. Your cloud backup and local data are kept. Deleting the cloud backup is a separate action.',
    confirmDisable: 'Turn off sync',
    deleteTitle: 'Delete the encrypted cloud backup?',
    deleteDescription:
      'Only this account’s cloud backup is deleted. Local data is kept. You will need a new backup to restore on another device.',
    backupRetention:
      'After deletion, service backup copies may be retained for up to {{days}} days.',
    deleteCheck: 'I confirm deletion of this cloud backup.',
    confirmDelete: 'Delete cloud backup',
    restoreTitle: 'Review before restoring',
    restoreDescription:
      'Review the categories below. Sensitive values stay hidden. Nothing is restored until you confirm.',
    deviceReview:
      'After restoring, review {{count}} device settings, including shortcuts, model paths, microphones and system permissions.',
    restoreMode: 'How to restore',
    merge: 'Merge and resolve conflicts',
    replace: 'Replace synced local data with cloud data',
    replaceWarning:
      'This replaces local data within the sync scope. Choose merge if you need to keep local changes.',
    restoreCheck: 'I have reviewed the restore mode and conflict choices.',
    applyRestore: 'Confirm restore',
    conflictProgress: '{{selected}} of {{total}} conflicts resolved',
    conflictItem: 'Conflict {{index}} · {{category}}',
    conflictLocal: 'Keep local',
    conflictCloud: 'Use cloud',
    previous: 'Previous',
    next: 'Next',
    scope: {
      preferences: 'App preferences and interface settings.',
      credentials:
        'ASR, LLM and Omni channels, including service API keys, IDs, access keys and secret keys.',
      personal: 'Dictionary, custom vocabulary presets, corrections, style packs and icons.',
      history: 'All dictation and quick-note text history, plus activity statistics.',
      device: 'Device configuration profiles, to review on the receiving device.',
      excluded:
        'Not included: OAuth login sessions, sync passwords or derived keys, OS credential files, PINs, device permissions, original audio/video recordings, or model weights.',
    },
    states: {
      disabled: 'Sync is off',
      sign_in_required: 'GitHub sign-in required',
      unlock_required: 'Enter your password to unlock',
      ready: 'Up to date',
      pending: 'Local changes are waiting to sync',
      syncing: 'Sync in progress',
      conflict: 'Review conflicting changes',
      failed: 'Sync needs attention',
      outcome_unknown: 'Waiting to confirm the cloud result',
      recovery_required: 'Local recovery is required',
    },
    categories: {
      preferences: 'App preferences',
      ui_preferences: 'Interface settings',
      channels: 'Service channels and credentials',
      provider_credentials: 'Service credentials',
      dictionary: 'Dictionary',
      vocabulary_presets: 'Custom vocabulary presets',
      corrections: 'Corrections',
      style_packs: 'Style packs and icons',
      history: 'Text history',
      activity: 'Activity statistics',
      device_profile: 'Device profiles',
      other: 'Other synced data',
    },
    conflictReasons: {
      both_modified: 'Both local and cloud versions changed.',
      delete_modify: 'One version was deleted while the other changed.',
      no_common_baseline: 'No shared baseline is available. Choose which version to keep.',
      other: 'Choose the local or cloud version. Values are not displayed.',
    },
    errors: {
      unknown: 'The operation could not be completed. Refresh the status and try again.',
      signIn: 'Sign in to GitHub again.',
      unlock: 'Unlock this device with your sync password first.',
      unavailable:
        'Encrypted sync is unavailable here. Use the native app and check the service later.',
      weakPassword: 'Choose a stronger password meeting the length and character requirements.',
      passwordMismatch: 'The two passwords do not match.',
      invalidPassword:
        'The password could not unlock this backup, or the encrypted data could not be verified.',
      secureStorage:
        'Secure storage denied access. Check device permissions, or unlock without remembering the key.',
      changed: 'Data changed during review. Close this dialog, refresh, and review a new preview.',
      accountChanged: 'The GitHub account changed. Refresh before continuing.',
      busy: 'Another sync task is running. Wait or cancel it first.',
      cancelled: 'The task was cancelled.',
      network: 'Could not reach the sync service. Check your connection and try again.',
      rateLimited: 'Too many requests. Wait before retrying.',
      outcomeUnknown:
        'The cloud result is not confirmed. Check the pending result before creating another backup.',
      recovery:
        'Local recovery is needed. Keep this device’s data and do not overwrite the cloud backup.',
      rolledBack: 'Restore failed and local changes were rolled back. Refresh before trying again.',
      tooLarge: 'The encrypted backup exceeds the service’s size limit.',
      reviewRequired: 'Review the full sync scope and the cloud restore preview before continuing.',
      choicesRequired: 'Choose local or cloud for every conflict.',
      invalidData: 'The encrypted backup could not be verified. Local data was not replaced.',
      localData: 'Could not prepare local data securely. Refresh and try again.',
    },
  },
  cloudSync: {
    title: 'Cloud sync',
  ...
  qa: {
    compact: {
      ...
      sendError: 'Could not send. Your draft is kept here; try again.',
      microphoneError: 'The microphone action failed. Try again.',
      modeError: 'Edit mode was not changed. Try again.',
      conversation: 'Current conversation',
      sending: 'Sending your question…',
      addUnavailable: 'Add content · not available yet',
      browserUnavailable: 'Preview cannot run commands',
      answer: 'OpenLess answer',
      layoutError: 'Could not expand the window. Close and reopen it.',
    },
    title: 'Ask',
  ...
  lessComputer: {
    desktop: {
      ...
      agentSettings: 'Choose in Settings',
      historyUnavailable: 'History · unavailable',
      sessionUnavailable: 'New session · unavailable',
      agentHint: 'Choose your agent in Settings.',
      workspace: 'Workspace',
      multitask: 'Multiple tasks',
      unavailable: 'Not available yet',
      historyHint: 'History and multiple sessions are not available for these four agents yet.',
      signedIn: 'Signed in',
      signIn: 'Sign in',
      currentSession: 'Current conversation',
      minimize: 'Minimize',
      maximize: 'Maximize / restore',
      windowError: 'The window action failed. Try again.',
      emptyHint: 'Describe a task, or use your configured voice shortcut to get started.',
      voiceHint: 'Hold your voice shortcut',
      idle: 'Waiting for a task',
      waitingApproval: 'Waiting for approval',
      submittingApproval: 'Submitting…',
      approvalError: 'Approval was not submitted. Try again.',
      approvalExpired: 'This turn has ended. Approval is no longer available.',
      sendError: 'Could not send. Your draft is saved here; try again.',
      browserUnavailable: 'This browser preview cannot run commands. Use the desktop app.',
      cancelHint: 'Cancel a running task from the capsule.',
      inputHint: 'Enter to send · Shift + Enter for a new line',
      activity: 'Task activity',
      noActivity: 'No activity yet',
      activityHint: 'Tool calls and approvals will appear here when a task starts.',
      currentTask: 'Current task',
      toolActive: 'Calling tool',
      toolReported: 'Call reported',
      approval: 'Action approval',
      apiCost: 'API cost this turn',
      activitySource: 'Updates with this task. Cost appears only when reported by the service.',
    },
    title: 'Less Computer',
  ...
  settings: {
    ...
    providers: {
      ...
      bailianProtocolNote:
        'Manual selection overrides model-name detection and is saved per channel for both validation and recording. Choose the API specified by the model documentation.',
  ...
  localAsr: {
    ...
    mirrorDesc:
      'Choose HuggingFace, the community mirror, or official ModelScope repositories for supported models.',
    mirrorHuggingface: 'HuggingFace official (huggingface.co)',
    mirrorHfMirror: 'Mainland mirror (hf-mirror.com)',
    mirrorModelscope: 'ModelScope official (modelscope.cn)',
    activeBadge: 'In use',
